    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md transition-opacity">
      <div className="glass-card rounded-3xl w-full max-w-md relative overflow-hidden shadow-[0_0_50px_rgba(168,85,247,0.2)] border border-neon-purple/30">
        ...
        <div className="p-8">
          ...
          {step === 'loading' && ( <div className="text-center py-12"><FaSpinner className="animate-spin text-neon-purple text-5xl mx-auto mb-4" /><p className="text-gray-400 font-heading">Memproses transaksi...</p></div> )}
          ...
          {step === 'qris' && (
            <div className="text-center">
              ...
              <div className="bg-white p-3 rounded-2xl inline-block mb-6 shadow-[0_0_20px_rgba(255,255,255,0.1)]"><img src={qrBase64} alt="QRIS" className="w-64 h-64 rounded-lg" /></div>
              <div className="flex items-center justify-center gap-2 text-neon-purple"><FaSpinner className="animate-spin text-lg" /><p className="text-sm font-medium">Menunggu pembayaran...</p></div>
            </div>
          )}
          ...
          {step === 'success' && panelData && (
            <div className="text-center">
              ...
              <div className="glass rounded-2xl p-5 text-left space-y-3 mb-8 border border-neon-purple/20">
                ...
                {!isAdmin && ( <><div className="border-t border-neon-purple/10 my-1"></div><p className="text-gray-400 text-sm">🆔 Server ID: <span className="text-white font-bold float-right">{panelData.serverId}</span></p></> )}
              </div>
