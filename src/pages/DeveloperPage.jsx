...
import { FaArrowLeft, FaGithub, FaDiscord, FaInstagram, FaEnvelope, FaCode, FaServer, FaYoutube, FaLock } from 'react-icons/fa';
...
export default function DeveloperPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0204] via-[#1a0800] to-[#050005] text-white font-body relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12 pt-24 animate-fade-in-up-orange">
        ...
        <div className="card-3d-orange bg-[#120500]/60 backdrop-blur-xl border border-orange-500/20 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(249,115,22,0.1)] relative overflow-hidden">
          ...
          {/* Tombol Menuju Admin Panel */}
          <div className="mt-12 border-t border-orange-500/10 pt-8 text-center">
            <Link to="/admin" className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-red-600/20 border border-red-500/30 text-red-400 font-heading font-bold tracking-wider hover:bg-red-600/30 hover:border-red-500/50 hover:shadow-[0_0_20px_rgba(220,38,38,0.2)] transition-all duration-300 hover:-translate-y-1">
              <FaLock /> Admin Panel
            </Link>
          </div>
